      ...
      <div className="right-column">
        ...
        <div>
          <ul>
            <h2>Skills:</h2>
            <li>
              Python 3, Javascript, ReactJS, Redux, HTML5, CSS, Flask, JSON,
              Git, MongoDB, SQL Databases, SCSS/SASS, Flexbox, CSS Grid{" "}
            </li>

            <li>
              a good attitude, strong listening skills, critical thinking,
              focus, adaptability, love of a good challenge
            </li>
          </ul>
        </div>
      </div>
